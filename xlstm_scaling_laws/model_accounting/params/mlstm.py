...
param_mlstm_layer = param_mlstm_prenorm + param_mlstm_qkv + \
    param_mlstm_if_gates + param_mlstm_o_gate + param_mlstm_outnorm + \
    param_mlstm_outproj
...
# total parameters
param_mlstm_model_blocks = (
    n_blocks * (param_mlstm_layer + param_ffn) + param_outnorm
)
param_mlstm_model_noembed = (
    param_mlstm_model_blocks + param_emb
)
param_mlstm_model_withembed = (
    param_mlstm_model_noembed + param_emb
)