...
param_att_layer = param_att_prenorm + param_att_qkv + param_att_outproj
...
# total parameters
param_llama_model_blocks = n_blocks * (param_att_layer + param_ffn) + param_outnorm
param_llama_model_noembed = param_llama_model_blocks + param_emb
param_llama_model_withembed = param_llama_model_noembed + param_emb
