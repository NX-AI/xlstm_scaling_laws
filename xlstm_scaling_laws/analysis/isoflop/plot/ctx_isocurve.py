...
def get_isoflop_ctx_powerlaw_plot(
    ...
    """Create the isoflop plots for the given compute."""
    ...
    def _add_isocurve_plot(ax: Axes, compute:str) -> Axes:
        ax = create_isocurve_plot(
            ...
            isoflop_polyfit_df=get_isoflop_polyfits_for_compute(
                compute=compute, x_col=x_col, y_col=y_col
            ),
            x_col=x_col,
            y_col=y_col,
            context_lengths=context_lengths,
            isoflop_datapoints_style_dicts=fit_ctx_color_dict,
            isoflop_polyfit_style_dicts=fit_ctx_color_dict,
    ...
    ax_6e18 = _add_isocurve_plot(ax=axes[0], compute=isoflop_tags[0])
    ax_1e19 = _add_isocurve_plot(ax=axes[1], compute=isoflop_tags[1])
    ax_3e19 = _add_isocurve_plot(ax=axes[2], compute=isoflop_tags[2])
